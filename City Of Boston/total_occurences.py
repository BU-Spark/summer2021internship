...
keywords = pd.read_csv(
    'https://raw.githubusercontent.com/zahradaniar/summer2021internship/master/City%20Of%20Boston/spanish_keywords_and_categories.csv',
    header=None)
keyword_dict = {}
...
articles = pd.read_csv(
    'https://raw.githubusercontent.com/singerep/summer2021internship/COB-ElMundo/City%20Of%20Boston/data/ElMundo_Jan2020_to_Jun2021.csv').dropna()
...
plt.xlabel('Date')
plt.title('El Mundo Boston Category Frequency (Rolling 7 Day Count)')
